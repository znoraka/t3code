...
export function createEnvironmentApi(rpcClient: WsRpcClient): EnvironmentApi {
  return {
    ...
    git: {
      ...
      listPullRequests: rpcClient.git.listPullRequests,
      getPullRequestDiff: rpcClient.git.getPullRequestDiff,
      getPullRequestFileDiff: rpcClient.git.getPullRequestFileDiff,
      getPullRequestReviewComments: rpcClient.git.getPullRequestReviewComments,
      postPullRequestComment: rpcClient.git.postPullRequestReviewComment,
      getPullRequestIssueComments: rpcClient.git.getPullRequestIssueComments,
      postPullRequestIssueComment: rpcClient.git.postPullRequestIssueComment,
      getPullRequestBody: rpcClient.git.getPullRequestBody,
      getPullRequestViewedFiles: rpcClient.git.getPullRequestViewedFiles,
      setPullRequestFileViewed: rpcClient.git.setPullRequestFileViewed,
      submitPullRequestReview: rpcClient.git.submitPullRequestReview,
      mergePullRequest: rpcClient.git.mergePullRequest,
      getPullRequestDetail: rpcClient.git.getPullRequestDetail,
      editPullRequest: rpcClient.git.editPullRequest,
      getRepositoryCollaborators: rpcClient.git.getRepositoryCollaborators,
    },
    orchestration: {
