...
export const RPC_REQUIRED_SCOPES = {
  ...
  // [FORK] PR workspace RPCs. Same domain as the upstream git.* entries above,
  // so reads take orchestration:read and mutations take orchestration:operate.
  [WS_METHODS.gitListPullRequests]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestDetail]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestBody]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestDiff]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestFileDiff]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestReviewComments]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestIssueComments]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetPullRequestViewedFiles]: AuthOrchestrationReadScope,
  [WS_METHODS.gitGetRepositoryCollaborators]: AuthOrchestrationReadScope,
  [WS_METHODS.gitPostPullRequestReviewComment]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitPostPullRequestIssueComment]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitSetPullRequestFileViewed]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitSubmitPullRequestReview]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitMergePullRequest]: AuthOrchestrationOperateScope,
  [WS_METHODS.gitEditPullRequest]: AuthOrchestrationOperateScope,
