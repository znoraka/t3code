...
[`Deployment`](/providers/kubernetes/deployment) synthesizes a
Kubernetes `Deployment`, `Service`, and `ServiceAccount`, with
bindings landing as pod-identity IAM.

[`Job`](/providers/kubernetes/job) is the run-to-completion
...
[`Manifest`](/providers/kubernetes/manifest) applies any raw
...
[`HelmChart`](/providers/kubernetes/helmchart) installs Helm charts
