...
for (const mode of Playwright.SERVER_METHODS) {
  test.describe(mode, () => {
    ...
    // fixture's gate (see packages/frontend-frameworks/fixtures/sveltekit/scripts/e2e.mjs for the full
    ...
    test.skip(
      ...
      "Windows CI runner socket-buffer exhaustion (see packages/frontend-frameworks/fixtures/sveltekit/scripts/e2e.mjs)",
    );
