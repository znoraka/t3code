...
// each test's wall time is dominated by workers.dev edge-propagation waits,
// so overlapping them collapses the file from the sum of all tests (~7 min)
// to roughly the slowest single test.
describe.concurrent("scratch", () => {
  test.provider(
