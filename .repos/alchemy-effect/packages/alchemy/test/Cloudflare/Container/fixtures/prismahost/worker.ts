...
import { PrismaHostContainerObject } from "./object.ts";

export default class PrismaHostContainerWorker extends Cloudflare.Worker<PrismaHostContainerWorker>()(
  "PrismaHostContainerWorker",
  {
    main: import.meta.url,
  },
  Effect.gen(function* () {
    const objects = yield* PrismaHostContainerObject;
