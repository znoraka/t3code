...
import { PlanetscaleHostContainerObject } from "./object.ts";

export default class PlanetscaleHostContainerWorker extends Cloudflare.Worker<PlanetscaleHostContainerWorker>()(
  "PlanetscaleHostContainerWorker",
  {
    main: import.meta.url,
  },
  Effect.gen(function* () {
    const objects = yield* PlanetscaleHostContainerObject;
