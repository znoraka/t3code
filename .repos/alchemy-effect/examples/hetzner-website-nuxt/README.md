# Hetzner Website: Nuxt

Deploys a [Nuxt](https://nuxt.com) site to Hetzner with
`Hetzner.Website.Nuxt` — no adapter setup in the project config.
...
const site = yield* Hetzner.Website.Nuxt("NuxtSite", {
  env: { GREETING: "Hello from Nuxt on Hetzner!" },
});
```
