 ...
 * the local `Website.Server` provider — no Hetzner Server, no Hetzner, no S3;
...
const MARKER = "Next.js on Hetzner";
const MARKER_V2 = "Next.js on Hetzner [dev-v2]";
...
test(
  ...
  async () => {
    ...
    expect(home).toContain("Hello from Next.js on Hetzner!");
