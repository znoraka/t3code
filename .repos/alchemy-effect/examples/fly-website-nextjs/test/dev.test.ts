 ...
 * the local `Website.Server` provider — no Fly Machine, no Fly, no S3;
...
const MARKER = "Next.js on Fly";
const MARKER_V2 = "Next.js on Fly [dev-v2]";
...
test(
  ...
  async () => {
    ...
    expect(home).toContain("Hello from Next.js on Fly!");
