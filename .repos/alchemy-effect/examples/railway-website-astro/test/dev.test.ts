...
const MARKER = "server-rendered in a Railway Service";
const MARKER_V2 = "server-rendered in a Railway Service [dev-v2]";
...
test(
  ...
  async () => {
    ...
    expect(home).toContain("Hello from Astro on Railway!");
