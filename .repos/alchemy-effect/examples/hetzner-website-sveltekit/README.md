# Hetzner Website: SvelteKit

Deploys a [SvelteKit](https://svelte.dev/docs/kit) site to Hetzner with
`Hetzner.Website.SvelteKit` — no adapter setup in the project config.
...
const site = yield* Hetzner.Website.SvelteKit("SvelteKitSite", {
  env: { GREETING: "Hello from SvelteKit on Hetzner!" },
});
```
